...
<head>
    <script src="https://app.privacybee.io/cookie-banner.js" website-id="cmhjhi5b404opy97sv5uffi8j" async></script> <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Datenschutzerklärung | webstudios.ch</title>
    <meta name="description" content="Datenschutzerklärung von webstudios.ch gemäss Schweizer DSG. Informationen zur Verarbeitung Ihrer Daten durch Scherrer WebStudios, Küssnacht."> <meta name="robots" content="noindex, nofollow">
    ...
    <style>
        ...
        .content-container strong { font-weight: 600; }
    </style>
</head>
<body x-data="{ isMobileMenuOpen: false }" class="bg-[#F8F7F4] text-[#2c2c2c] flex flex-col min-h-screen">
...
<header class="fixed top-0 w-full z-50 p-4 flex justify-center">
    <nav class="relative w-full max-w-6xl flex justify-between items-center px-6 py-2 bg-white/50 backdrop-blur-lg rounded-full border border-gray-200">
        ...
        <div class="hidden md:flex absolute left-1/2 -translate-x-1/2 space-x-10">
            ...
            <a href="/ueber-uns" class="text-gray-500 hover:text-black font-medium transition-colors duration-300 text-lg">Über uns</a>
        ...
        <button 
            ...
            class="md:hidden text-gray-600 hover:text-black focus:outline-none"
...
<div 
    ...
    class="fixed inset-0 z-[60] bg-[#F8F7F4] p-8 flex flex-col items-center justify-center md:hidden" 
    style="display: none;" 
...
>
    <button 
        ...
        class="absolute top-7 right-7 text-gray-500 hover:text-black"
    ...
    <nav class="flex flex-col items-center space-y-8">
        <a href="/services" @click="isMobileMenuOpen = false" class="text-3xl font-medium text-gray-500 hover:text-[#2c2c2c] transition-colors">Services</a>
        <a href="/prozess" @click="isMobileMenuOpen = false" class="text-3xl font-medium text-gray-500 hover:text-[#2c2c2c] transition-colors">Prozess</a>
        <a href="/ueber-uns" @click="isMobileMenuOpen = false" class="text-3xl font-medium text-gray-500 hover:text-[#2c2c2c] transition-colors">Über uns</a>
        <a href="/kontakt" @click="isMobileMenuOpen = false" class="text-3xl font-medium text-gray-500 hover:text-[#2c2c2c] transition-colors">Kontakt</a>
        <a href="/kontakt" @click="isMobileMenuOpen = false" class="mt-8 inline-block bg-[#E86A33] hover:bg-[#D05F2C] text-white font-bold py-3 px-8 rounded-full text-lg transition-colors duration-300">
             Gratis Offerte anfragen
        </a>
    </nav>
</div>
    ...
    <main>
        <section class="pt-48 pb-24 bg-gradient-to-b from-orange-50/50 to-gray-50">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up">
                <h1 class="text-5xl sm:text-6xl font-extrabold text-gray-900">Datenschutzerklärung</h1>
                <p class="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Wie wir Ihre Daten schützen.</p>
            </div>
        </section>
        ...
        <section class="py-24 bg-white">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl content-container">
                ...
                <p>
                  <strong>Verantwortlich für die Datenverarbeitung dieser Webseite:</strong><br>
                ...
                <p>
                    E-Mail: info@webstudios.ch<br>
                    Link zum Impressum: <a href="/impressum">Impressum</a> </p>
                <p>
                    Als minderjähriger Inhaber handle ich mit der Zustimmung meiner gesetzlichen Vertreter. Für alle datenschutzrechtlichen Anliegen können Sie sich an die oben genannte Adresse oder E-Mail wenden.
                </p>

                <hr class="my-8 border-gray-200">

                <h2>2. Von PrivacyBee generierte Datenschutzhinweise</h2>
                <p>Nachfolgend finden Sie die automatisch generierten und aktuell gehaltenen Datenschutzhinweise unseres Dienstleisters PrivacyBee AG zu den von uns eingesetzten Diensten und Cookies.</p>
                
                <script src="https://app.privacybee.io/widget.js" defer></script>
                <privacybee-widget website-id="cmhjhi5b404opy97sv5uffi8j" type="dsg" lang="de"></privacybee-widget>
     ...
     <div class="container mx-auto px-4 sm:px-6 lg:px-8">
         <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left items-start"> 
             ...
             <div class="space-y-4 md:pt-10"> 
                 <a href="/" class="inline-block"> <img src="logo.png" alt="webstudios Logo" class="h-32 w-auto -mt-[6.7rem] -mb-10 shimmer-logo mx-auto md:mx-0"> 
                 </a>
             ...
             <div>
                 ...
                 <ul class="space-y-2">
                     ...
                     <li><a href="/ueber-uns" class="hover:text-black transition-colors">Über uns</a></li>
