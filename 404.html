...
<script src="https://app.privacybee.io/cookie-banner.js" website-id="cmhjhi5b404opy97sv5uffi8j"></script>
    ...
    <title>Seite nicht gefunden (404) | webstudios.ch</title>
    <meta name="description" content="Hoppla! Die von Ihnen gesuchte Seite auf webstudios.ch konnte nicht gefunden werden. Kehren Sie zur index zurück.">
    <meta name="robots" content="noindex, nofollow"> <link rel="icon" type="image/png" href="favicon.png">
...
<body class="bg-[#F8F7F4] text-[#2c2c2c] flex flex-col min-h-screen">
...
<div id="mobile-menu" class="hidden md:hidden fixed top-24 left-4 right-4 z-40 bg-white/90 backdrop-blur-lg rounded-2xl border border-gray-200 p-4 space-y-2">
    ...
    <main class="flex-grow flex items-center justify-center pt-32 pb-16">
        <section class="min-h-[60vh] flex items-center justify-center text-center w-full"> 
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 bg-white p-12 rounded-3xl shadow-lg border border-gray-200 max-w-xl">
                <p class="text-6xl font-bold text-[#E86A33] mb-4">404</p> 
                <h1 class="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-4">Seite nicht gefunden</h1> 
                <p class="mt-4 text-lg text-gray-600 max-w-xl mx-auto">Entschuldigung, aber die Seite, die Sie suchen, existiert nicht oder wurde verschoben.</p>
                <a href="./" class="mt-12 inline-block bg-[#E86A33] hover:bg-[#D05F2C] text-white font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out transform hover:scale-105 glow-on-hover">
                    Zurück zur index
                </a>
            </div>
        </section>
...
<footer class="bg-white text-gray-500 py-12 border-t border-gray-200 mt-auto">
